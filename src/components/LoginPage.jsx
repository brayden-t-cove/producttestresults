...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    if (err === 'domain_not_allowed') {
      setAuthError('Your email domain is not yet authorized. Your request has been submitted for review.');
      // Clean the URL
    ...
    <div className="login-page">
      <div className="login-card">
        ...
        <p className="login-footer">
          Access is restricted to authorized work domains. If your domain isn't recognized, your sign-in attempt will be submitted for review.
        </p>
      </div>
    </div>
  );
