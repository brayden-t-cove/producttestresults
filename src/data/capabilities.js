export const CAPABILITY_GROUPS = {
  ...
  camera: [
    ...
    { label: 'Edge Based Features', capabilities: [
      ...
      { id: 'package-detection-edge', label: 'Package Detection' },
      { id: 'vehicle-detection-edge', label: 'Vehicle Detection' },
      { id: 'animal-detection-edge', label: 'Animal Detection' },
    ]},
    { label: 'Cloud Based Features', capabilities: [
      { id: 'motion-detection-cloud', label: 'Motion Detection' },
      { id: 'person-detection-cloud', label: 'Person Detection' },
      { id: 'custom-zones-cloud', label: 'Custom Motion Zones' },
      { id: 'distance-detection-cloud', label: 'Distance Detection' },
